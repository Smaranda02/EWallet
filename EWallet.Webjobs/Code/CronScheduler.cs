    ...
    public sealed class CronScheduler : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            while (await tickTimer.WaitForNextTickAsync(stoppingToken))
            {
                ...
                await RunActiveJobs(runMap, now, stoppingToken);
        ...
        private async Task RunActiveJobs(IReadOnlyDictionary<DateTime, List<Type>> runMap, DateTime now, CancellationToken stoppingToken)
        {
