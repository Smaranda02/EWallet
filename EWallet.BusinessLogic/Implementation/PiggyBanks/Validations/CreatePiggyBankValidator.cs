...
{
    public class CreatePiggyBankValidator : AbstractValidator<CreatePiggyBankViewModel>
    {

        public CreatePiggyBankValidator() {


            RuleFor(r => r.TargetSum)
                .NotEmpty().WithMessage("Please enter an amount")
                //.Must(ValidationFunctions.BeNumeric).WithMessage("The amount must be a number")

                .LessThan(99999).WithMessage("The maximum amount allowed is 999999")
